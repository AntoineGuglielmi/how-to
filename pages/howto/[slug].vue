...
<template>
	...
	<Title1 class="text-center lg:text-left flex flex-col">
		<span v-if="topic" class="text-[0.5em]">How to</span>{{ title }}
	</Title1>
	<ContentDoc
		:head="false"
		:path="contentPath"
	...
	>
		<template #not-found>
			<p class="text-[1.5rem] font-thin">Sorry, we're still confused on this topic <!--<Icon name="twemoji:person-shrugging" />--> <Icon name="fluent-emoji:face-with-open-eyes-and-hand-over-mouth" /></p>
		</template>
	</ContentDoc>
</template>
